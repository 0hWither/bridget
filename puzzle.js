...
function loadInitialFile() {
  puzzle.srcImage.src = "img/puzzle1.png";
}
//-----------------------------------------------------------------------------
  ...
  animate = function () {
    ...
    switch (state) {
      ...
      case 60: // winning
        ...
        switch(puzzle_name) {
            case "puzzle1":
                console.log("puzzle 1 completed")
                
                confetti();
                document.body.className="color3"
                document.getElementById("b_get_name").className="hide"
                document.getElementById("titleForPuzzle").innerHTML="♡︎ Congratulations! ♡︎"
                setTimeout(function(){
                    document.getElementById("puzzleTitle1").className="fadeOut center_text letter"
                    document.getElementById("forPuzzle").className="fadeOut"
                    document.body.className="color4"
                    document.getElementById("text_title_1").className="cursor typewriter-animation"
                },1500)
                setTimeout(function(){
                    document.getElementById("text_title_1").className="cursor hide_cursor typewriter-animation"
                },5500)
                setTimeout(function(){
                  document.getElementById("paragraph_pt1").className="paragraph1"
                  document.getElementById("container").className="center containerOffset"
              },6500)
              setTimeout(function(){
                document.getElementById("paragraph_pt1").className="paragraph1v2 fadeIn"
                document.getElementById("text_title_1").className="cursor hide_cursor typewriter-animation fadedColor"
                document.getElementById("container").className="center container"
                stopConfetti()
            },6600)
            setTimeout(function(){
                document.getElementById("next_btn").className="wrapper fadeIn"
                document.getElementById("btn_a").className="pointer btn_a"
          },7600)
            
                
                break;
            case "puzzle2":
                console.log("puzzle 2 completed");
                document.getElementById("titleForPuzzle").innerHTML="♡︎ Congratulations! ♡︎"
                confetti();
                setTimeout(function(){
                  ...
                  document.getElementById("forPuzzle").className="fadeOut";
                  stopConfetti();
                  document.getElementById("bridge_gf_text").className="fadeIn text"
                },2000)
                setTimeout(function(){
                  startShift();
                },3000)
                setTimeout(function(){
                  stopShift();
                  document.getElementById("paragraph2_wrapper").className="fadeOut center2"
                },11000)
                setTimeout(function(){
                  document.getElementById("bridge_gf_text").className="fadeOut text"
                  document.getElementById("paragraph2_wrapper").className="fadeIn center2"
                  paragraph2Anim();
                  
                },12000)
                setTimeout(function(){
                  document.getElementById("btn_a").className="btn_b pointer"
                  document.getElementById("next_btn").className="wrapper fadeIn updateZ";
                },13000)
                
                break;
            case "puzzle3":
                console.log("puzzle 3 completed")
                break;
        }
...
function loadnextPuzzle() {
    ...
    console.log("loading..");
  document.getElementById("container").className="center container fadeOut";
  document.getElementById("next_btn").className="wrapper fadeOut"
  document.getElementById("btn_a").className="btn_a"
  setTimeout(function(){
    document.body.className="color1"
    document.getElementById("photoPicker").className="fadeIn wrapper2 center updateZ"
    document.getElementById("titleForPuzzle").innerHTML="Pick a Photo!"
    document.getElementById("puzzleTitle1").className="fadeIn ml1 letter"
    document.getElementById("puzzle_choice_1").addEventListener("click",pc1);
    document.getElementById("puzzle_choice_2").addEventListener("click",pc2);
    document.getElementById("puzzle_choice_3").addEventListener("click",pc3); 
  },500)
    } else if (puzzle_name=="puzzle2") {
    console.log("puzzle 2 completed, advancing to next portion..");
    }
...
const hideSelection = () => {
  ...
  document.getElementById("photoPicker").className="fadeOut wrapper2 center"
  document.getElementById("titleForPuzzle").innerHTML="♡︎ Puzzle 2 ♡︎"
  document.body.className="color2"
  setTimeout(function(){
    document.getElementById("photoPicker").className="hide wrapper2 center"
  },600);
}
...
function loadPuzzle(puzzleName) {
  ...
  puzzle = new Puzzle({ container: "forPuzzle" });
  document.getElementById("forPuzzle").className="fadeIn"
  autoStart = isMiniature();
  
  // CHANGE IMAGE
  console.log("before : "+puzzle.srcImage.src)
  console.log(puzzleName)
  switch(puzzleName) {
    case "selection1":
      console.log("puzzle1");
      puzzle.srcImage.src="img/puzzle2.1.png"
      break;
    case "selection2":
      console.log("puzzle2");
      puzzle.srcImage.src="img/puzzle2.2.png"
      break;
    case "selection3":
      console.log("puzzle3");
      puzzle.srcImage.src="img/puzzle2.3.png"
      break;
  }
  console.log("after : "+puzzle.srcImage.src)
...
const pc1 = () => {loadPuzzle("selection1")}
const pc2 = () => {loadPuzzle("selection2")}
const pc3 = () => {loadPuzzle("selection3")}

document.getElementById("next_btn").addEventListener("click", loadnextPuzzle);
